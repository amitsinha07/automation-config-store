...
import { onConfirmUserConfGenerator } from "./generator";

export class MockOnConfirmUserConfirmationBusClass extends MockAction {
  ...
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onConfirmUserConfGenerator(existingPayload, sessionData);
  }
  async validate(
  targetPayload: any,
