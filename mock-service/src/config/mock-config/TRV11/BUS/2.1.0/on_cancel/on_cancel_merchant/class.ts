...
import { onCancelMerchantGenerator } from "./generator";

export class MockOnCancelMerchantBus210Class extends MockAction {
  ...
  name(): string {
    return "on_cancel_merchant_BUS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onCancelMerchantGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for on_cancel_BUS_210";
  }
  async validate(
    targetPayload: any,
