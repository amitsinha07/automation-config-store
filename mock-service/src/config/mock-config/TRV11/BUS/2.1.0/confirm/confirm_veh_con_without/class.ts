...
import {  confirmVehConWithoutUpdateGenerator } from "./generator";

export class MockConfirmVehConWithoutBus210Class extends MockAction {
  ...
  name(): string {
    return "confirm_veh_con_BUS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return confirmVehConWithoutUpdateGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for cancel_hard_BUS_210";
  }
  async validate(
    targetPayload: any,
