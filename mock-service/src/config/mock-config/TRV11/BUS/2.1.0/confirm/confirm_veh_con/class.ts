...
import { confirmVehConGenerator } from "./generator";

export class MockConfirmVehConBus210Class extends MockAction {
  ...
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return confirmVehConGenerator(existingPayload, sessionData);
  }
