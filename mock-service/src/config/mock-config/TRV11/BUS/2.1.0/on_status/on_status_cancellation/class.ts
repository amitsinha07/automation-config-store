...
import { onStatusCancellationGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnStatusCancellationBus210Class extends MockAction {
  ...
  name(): string {
    return "on_status_cancellation_BUS_210";
  }
  get description(): string {
    return "Mock for on_status_cancellation_BUS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onStatusCancellationGenerator(existingPayload, sessionData);
  }
async validate(
  targetPayload: any,
