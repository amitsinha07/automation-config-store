...
import { onUpdateVehQrGenerator } from "./generator";

export class MockOnUpdateVehicleQrBus210Class extends MockAction {
  ...
  name(): string {
    return "on_update_veh_QR_BUS_210";
  }
  get description(): string {
    return "Mock for on_update_veh_QR_BUS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onUpdateVehQrGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
