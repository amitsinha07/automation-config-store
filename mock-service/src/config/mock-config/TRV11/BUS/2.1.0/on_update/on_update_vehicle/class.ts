...
import { onUpdateVehConGenerator } from "./generator";

export class MockOnUpdateVehicleBus210Class extends MockAction {
  ...
  name(): string {
    return "on_update_veh_con_BUS_210";
  }
  get description(): string {
    return "Mock for on_update_veh_con_BUS_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onUpdateVehConGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
