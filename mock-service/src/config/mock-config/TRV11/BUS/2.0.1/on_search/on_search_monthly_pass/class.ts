...
import { onSearchMonthlyPassGenerator } from "./generator";

export class MockOnSearchMonthlyPassBus201Class extends MockAction {
  ...
  name(): string {
    return "on_search_monthly_pass_BUS_201";
  }
  get description(): string {
    return "Mock for on_search_BUS_201";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onSearchMonthlyPassGenerator(existingPayload, sessionData);
  }
  async validate(
  targetPayload: any,
