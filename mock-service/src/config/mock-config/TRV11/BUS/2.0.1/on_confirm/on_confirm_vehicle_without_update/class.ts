...
export class MockOnConfirmVehConWithoutUpdateBus201Class extends MockAction {
  ...
  name(): string {
    return "on_confirm_veh_con_BUS_201";
  }
...
export class MockOnConfirmVehConBusQr201Class extends MockAction {
  get saveData(): saveType {
    return yaml.load(
      readFileSync(path.resolve(__dirname, "../save-data.yaml"), "utf8")
    ) as saveType;
