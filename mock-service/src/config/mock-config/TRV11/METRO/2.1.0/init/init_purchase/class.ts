...
import { initPurchaseGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockInitMetroPurchase210Class extends MockAction {
  ...
  name(): string {
    return "init_METRO_PURCHASE_210";
  }
  get description(): string {
    return "Mock for init_METRO_PURCHASE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return initPurchaseGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
