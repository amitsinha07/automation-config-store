...
import { initRechargeGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockInitMetroRecharge210Class extends MockAction {
  ...
  name(): string {
    return "init_METRO_RECHARGE_210";
  }
  get description(): string {
    return "Mock for init_METRO_RECHARGE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return initRechargeGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
