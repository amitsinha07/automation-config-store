...
import { onInitPurchaseGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnInitMetroPurchase210Class extends MockAction {
  ...
  name(): string {
    return "on_init_METRO_PURCHASE_210";
  }
  get description(): string {
    return "Mock for on_init_METRO_PURCHASE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onInitPurchaseGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
