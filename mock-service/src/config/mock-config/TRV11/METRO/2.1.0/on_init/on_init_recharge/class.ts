...
import { onInitRechargeGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnInitMetroRecharge210Class extends MockAction {
  ...
  name(): string {
    return "on_init_METRO_RECHARGE_210";
  }
  get description(): string {
    return "Mock for on_init_METRO_RECHARGE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onInitRechargeGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
