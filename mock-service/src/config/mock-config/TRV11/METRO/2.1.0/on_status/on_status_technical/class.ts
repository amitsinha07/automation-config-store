...
import { onStatusTechnicalGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnStatusTechnicalMetro210Class extends MockAction {
  ...
  name(): string {
    return "on_status_tech_METRO_210";
  }
  get description(): string {
    return "Mock for on_status_tech_METRO_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onStatusTechnicalGenerator(existingPayload, sessionData);
  }
  async validate(
  targetPayload: any,
