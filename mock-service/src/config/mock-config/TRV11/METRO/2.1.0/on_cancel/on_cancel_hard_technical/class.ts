...
import { onCancelHardTechnicalGenerator } from "./generator";

export class OnCancelHardTechnicalMetro210Class extends MockAction {
  ...
  name(): string {
    return "on_cancel_hard_tech_METRO_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onCancelHardTechnicalGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for on_cancel_hard_tech_METRO_210";
  }
  async validate(
    targetPayload: any,
