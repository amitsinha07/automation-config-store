...
import { onCancelSoftTechnicalGenerator } from "./generator";

export class OnCancelSoftTechnicalMetro210Class extends MockAction {
  ...
  name(): string {
    return "on_cancel_soft_tech_METRO_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onCancelSoftTechnicalGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for on_cancel_soft_tech_METRO_210";
  }
  async validate(
    targetPayload: any,
