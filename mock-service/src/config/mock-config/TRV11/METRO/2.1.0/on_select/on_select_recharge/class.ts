...
import { onSelectRechargeGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnSelectMetroRecharge210Class extends MockAction {
  ...
  name(): string {
    return "on_select_METRO_RECHARGE_210";
  }
  get description(): string {
    return "Mock for on_select_METRO_RECHARGE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onSelectRechargeGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
