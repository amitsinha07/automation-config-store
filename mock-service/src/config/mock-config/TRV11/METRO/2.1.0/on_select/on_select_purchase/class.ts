...
import { onSelectPurchaseGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnSelectMetroPurchase210Class extends MockAction {
  ...
  name(): string {
    return "on_select_METRO_PURCHASE_210";
  }
  get description(): string {
    return "Mock for on_select_METRO_PURCHASE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onSelectPurchaseGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
