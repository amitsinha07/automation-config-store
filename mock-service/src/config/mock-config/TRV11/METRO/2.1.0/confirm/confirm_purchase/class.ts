...
import { confirmPurchaseGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockConfirmMetroPurchase210Class extends MockAction {
  ...
  name(): string {
    return "confirm_METRO_PURCHASE_210";
  }
  get description(): string {
    return "Mock for confirm_METRO_PURCHASE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return confirmPurchaseGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
