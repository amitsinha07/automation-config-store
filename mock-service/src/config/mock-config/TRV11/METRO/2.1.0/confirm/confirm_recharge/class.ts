...
import { confirmRechargeGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockConfirmMetroRecharge210Class extends MockAction {
  ...
  name(): string {
    return "confirm_METRO_RECHARGE_210";
  }
  get description(): string {
    return "Mock for confirm_METRO_RECHARGE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return confirmRechargeGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
