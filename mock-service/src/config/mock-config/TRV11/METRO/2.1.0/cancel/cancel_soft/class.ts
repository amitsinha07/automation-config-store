...
import { cancelSoftGenerator } from "./generator";

export class MockCancelSoftMetro210Class extends MockAction {
  ...
  name(): string {
    return "cancel_soft_METRO_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return cancelSoftGenerator(existingPayload, sessionData);
  }
  get description(): string {
    return "Mock for cancel_soft_METRO_210";
  }
  async validate(
    targetPayload: any,
