...
import { onConfirmRechargeGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnConfirmMetroRecharge210Class extends MockAction {
  ...
  name(): string {
    return "on_confirm_METRO_RECHARGE_210";
  }
  get description(): string {
    return "Mock for on_confirm_METRO_RECHARGE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onConfirmRechargeGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
