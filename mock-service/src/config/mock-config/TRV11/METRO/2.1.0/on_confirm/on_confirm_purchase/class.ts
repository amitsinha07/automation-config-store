...
import { onConfirmPurchaseGenerator } from "./generator";
import { SessionData } from "../../../../session-types";

export class MockOnConfirmMetroPurchase210Class extends MockAction {
  ...
  name(): string {
    return "on_confirm_METRO_PURCHASE_210";
  }
  get description(): string {
    return "Mock for on_confirm_METRO_PURCHASE_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onConfirmPurchaseGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
