...
import { onUpdateAcceptedGenerator } from "./generator";

export class MockOnUpdateAcceptedMetro210Class extends MockAction {
  ...
  name(): string {
    return "on_update_accepted_METRO_210";
  }
  get description(): string {
    return "Mock for on_update_accepted_METRO_210";
  }
  generator(existingPayload: any, sessionData: SessionData): Promise<any> {
    return onUpdateAcceptedGenerator(existingPayload, sessionData);
  }
  async validate(
    targetPayload: any,
