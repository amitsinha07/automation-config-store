...
export class MockEntityEkycDetailsFormClass extends MockAction {
	name(): string {
		return "entity_kyc_form_verification_status";
	}
	get description(): string {
		return "Mock for entity_kyc_form_verification_status";
	}
	generator(existingPayload: any, sessionData: SessionData): Promise<any> {
		console.log("entity_kyc_form_verification_status generator", existingPayload, sessionData);
	...
	async validate(
		...
		const formLink = sessionData["entity_kyc_form_verification_status"];
		if (!formLink) {
	...
	override async __forceSaveData(
		...
		return {
			...sessionData,
			entity_kyc_form_verification_status: resolveFormActions(formLink, formData),
		};
	}
	...
	get saveData(): saveType {
		return { "save-data": { entity_kyc_form_verification_status: "entity_kyc_form_verification_status" } };
	}
	get defaultData(): any {
		return {};
	}
