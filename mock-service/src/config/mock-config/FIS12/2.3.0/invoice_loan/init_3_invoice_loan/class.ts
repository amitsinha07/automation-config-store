...
export class MockInit3InvoiceLoanClass extends MockAction {
    ...
    name(): string { return "init_3_invoice_loan"; }
    get description(): string { return "Mock for init_3_invoice_loan"; }
