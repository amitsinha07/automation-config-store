...
/**
 * Init 3 Generator for Invoice Loan
 * 
 * Logic:
...
export async function initInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("init_3_invoice_loan generator - Session data:", sessionData);
    ...
    console.log("init_3_invoice_loan payload generated successfully");
