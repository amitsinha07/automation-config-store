...
/**
 * On Update Generator for Invoice Loan Items
 * 
 * Logic:
 ...
 */
export async function onUpdateInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_update_invoice_loan_items generator - Session data:", sessionData);
    ...
    console.log("on_update_invoice_loan_items payload generated successfully");
