...
export class MockLoanAggrementVerificationStatusClass extends MockAction {
	name(): string {
		return "loan_aggrement_verification_status";
	}
	get description(): string {
		return "Mock for loan_aggrement_verification_status";
	}
	...
	async validate(
		...
		const formLink = sessionData["loan_aggrement_verification_status"];
		if (!formLink) {
	...
	override async __forceSaveData(
		...
		return {
			...sessionData,
			loan_aggrement_verification_status: resolveFormActions(formLink, formData),
		};
	}
	...
	get saveData(): saveType {
		return { "save-data": { loan_aggrement_verification_status: "loan_aggrement_verification_status" } };
	}
	get defaultData(): any {
		return {};
	}
