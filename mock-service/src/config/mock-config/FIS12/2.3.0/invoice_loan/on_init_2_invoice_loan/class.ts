...
export class MockOnInit2InvoiceLoanClass extends MockAction {
    ...
    name(): string { return "on_init_2_invoice_loan"; }
    get description(): string { return "Mock for on_init_2_invoice_loan"; }
