...
export class MockOnInit5InvoiceLoanClass extends MockAction {
    ...
    name(): string { return "on_init_4_invoice_loan"; }
    get description(): string { return "Mock for on_init_4_invoice_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return onInitInvoiceLoanGenerator(existingPayload, sessionData); }
