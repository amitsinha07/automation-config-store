...
/**
 * Select 1 Generator for Invoice Loan
 * 
 * Logic:
 ...
 */
export async function selectInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("select_1_invoice_loan generator - Session data:", {
    ...
    console.log("select_1_invoice_loan payload generated successfully");
