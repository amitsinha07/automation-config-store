...
import { confirmInvoiceLoanGenerator } from "./generator";

export class MockConfirmInvoiceLoanClass extends MockAction {
    ...
    name(): string { return "confirm_invoice_loan"; }
    get description(): string { return "Mock for confirm_invoice_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return confirmInvoiceLoanGenerator(existingPayload, sessionData); }
