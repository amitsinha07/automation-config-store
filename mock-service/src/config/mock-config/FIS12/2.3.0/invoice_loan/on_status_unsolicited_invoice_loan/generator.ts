...
/**
 * On Status Unsolicited Generator for Invoice Loan
 * 
 * Logic:
...
export async function onStatusUnsolicitedGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_status_unsolicited_invoice_loan generator - Session data:", sessionData);
    ...
    console.log("on_status_unsolicited_invoice_loan payload generated successfully - Unsolicited status callback");
