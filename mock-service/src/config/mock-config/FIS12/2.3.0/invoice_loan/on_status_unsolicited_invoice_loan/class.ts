...
export class MockOnStatusUnsolicitedInvoiceLoanClass extends MockAction {
    ...
    name(): string { return "on_status_unsolicited_invoice_loan"; }
    get description(): string { return "Mock for on_status_unsolicited_invoice_loan"; }
