...
import { onConfirmInvoiceLoanGenerator } from "./generator";

export class MockOnConfirmInvoiceLoanClass extends MockAction {
    ...
    name(): string { return "on_confirm_invoice_loan"; }
    get description(): string { return "Mock for on_confirm_invoice_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return onConfirmInvoiceLoanGenerator(existingPayload, sessionData); }
