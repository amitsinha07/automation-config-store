...
/**
 * On Confirm Generator for Invoice Loan
 * 
 * Logic:
 ...
 */
export async function onConfirmInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_confirm_invoice_loan generator - Session data:", sessionData);
    ...
    console.log("on_confirm_invoice_loan payload generated successfully - Order state: ACCEPTED");
