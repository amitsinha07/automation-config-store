...
/**
 * On Select 1 Generator for Invoice Loan
 * 
 * Logic:
...
export async function onSelectInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_select_1_invoice_loan generator - Session data:", {
    ...
    console.log("on_select_1_invoice_loan payload generated successfully");
