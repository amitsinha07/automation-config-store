...
export class MockInit2InvoiceLoanClass extends MockAction {
    ...
    name(): string { return "init_2_invoice_loan"; }
    get description(): string { return "Mock for init_2_invoice_loan"; }
