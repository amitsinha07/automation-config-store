...
export class MockOnInit3InvoiceLoanClass extends MockAction {
    ...
    name(): string { return "on_init_3_invoice_loan"; }
    get description(): string { return "Mock for on_init_3_invoice_loan"; }
