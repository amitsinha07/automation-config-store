...
import { onStatusInvoiceLoanGenerator } from "./generator";

export class MockOnStatusInvoiceLoanClass extends MockAction {
    ...
    name(): string { return "on_status_invoice_loan"; }
    get description(): string { return "Mock for on_status_invoice_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return onStatusInvoiceLoanGenerator(existingPayload, sessionData); }
