...
/**
 * On Status Generator for Invoice Loan
 * 
 * Logic:
 ...
 */
export async function onStatusInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_status_invoice_loan generator - Session data:", sessionData);
    ...
    console.log("on_status_invoice_loan payload generated successfully - Order state: ACTIVE");
