...
/**
 * Update Generator for Invoice Loan Items
 * 
 * Logic:
 ...
 */
export async function updateInvoiceLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("update_invoice_loan_items generator - Session data:", sessionData);
    ...
    console.log("update_invoice_loan_items payload generated successfully");
