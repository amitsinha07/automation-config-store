...
export class MockOnInit4PersonalLoanClass extends MockAction {
    ...
    name(): string { return "on_init_4_personal_loan"; }
    get description(): string { return "Mock for on_init_4_personal_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return onInitPersonalLoanGenerator(existingPayload, sessionData); }
