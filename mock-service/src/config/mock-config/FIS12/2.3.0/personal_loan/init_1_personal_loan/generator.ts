...
/**
 * Init 1 Generator for Personal Loan
 * 
 * Logic:
...
export async function initPersonalLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("init_1_personal_loan generator - Session data:", {
    ...
    console.log("init_1_personal_loan payload generated successfully");
