export async function onSearchPersonalLoanGenerator(existingPayload: any, sessionData: any) {
    console.log("existingPayload on_search_personal_loan", existingPayload, sessionData);
