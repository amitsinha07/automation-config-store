...
export class MockInit4PersonalLoanClass extends MockAction {
    ...
    name(): string { return "init_4_personal_loan"; }
    get description(): string { return "Mock for init_4_personal_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return initPersonalLoanGenerator(existingPayload, sessionData); }
