...
import { onStatusPersonalLoanGenerator } from "./generator";
...
export class MockOnStatusPersonalLoanClass extends MockAction {
    ...
    get description(): string { return "Mock for on_status_personal_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return onStatusPersonalLoanGenerator(existingPayload, sessionData); }
