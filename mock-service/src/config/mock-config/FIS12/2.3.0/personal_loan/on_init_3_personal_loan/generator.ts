...
/**
 * On Init 3 Generator for Personal Loan
 * 
 * Logic:
...
export async function onInitPersonalLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_init_3_personal_loan generator - Session data:", sessionData);
    ...
    console.log("on_init_3_personal_loan payload generated successfully");
