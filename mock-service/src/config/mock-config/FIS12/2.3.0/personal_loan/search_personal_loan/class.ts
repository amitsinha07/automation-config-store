...
import { searchPersonalLoanGenerator } from "./generator";
...
export class MockSearchPersonalLoanClass extends MockAction {
    ...
    generator(existingPayload: any, sessionData: SessionData): Promise<any> {
        return searchPersonalLoanGenerator(existingPayload, sessionData);
    }
    ...
    async meetRequirements(sessionData: SessionData): Promise<MockOutput> {
        console.log("sessionData in search_personal_loan class", sessionData.message_id);
