...
import { statusPersonalLoanGenerator } from "./generator";
...
export class MockStatusPersonalLoanClass extends MockAction {
    ...
    get description(): string { return "Mock for status_personal_loan"; }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> { return statusPersonalLoanGenerator(existingPayload, sessionData); }
