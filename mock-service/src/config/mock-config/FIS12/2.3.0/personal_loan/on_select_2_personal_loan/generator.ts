...
/**
 * On Select 2 Generator for Personal Loan
 * 
 * Logic:
...
export async function onSelectPersonalLoanGenerator(existingPayload: any, sessionData: SessionData) {
    console.log("on_select_2_personal_loan generator - Session data:", {
    ...
    console.log("on_select_2_personal_loan payload generated successfully");
