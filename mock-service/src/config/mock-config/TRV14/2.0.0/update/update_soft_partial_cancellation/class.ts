...
import { updateSoftPartialCancellationGenerator } from "./generator";

export class MockUpdateSoftPartialCancellationClass extends MockAction {
    ...
    name(): string {
        return "update_soft_partial_cancellation";
    }
    get description(): string {
        return "Mock for update soft partial cancellation";
    }
    generator(existingPayload: any, sessionData: SessionData): Promise<any> {
        return updateSoftPartialCancellationGenerator(existingPayload, sessionData);
    }
